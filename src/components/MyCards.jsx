...
function MyCards() {
  const {cartMoney, darkMode} = useContext(addCart)
  ...
  return (
    <div className={styles.myCards}>
      <h1 className={`${styles.title} ${darkMode ? '_MyCards_darkMode__DY253' : ''}`}>My Cards</h1>
      <Swiper
        effect={"flip"}
        grabCursor={true}
        pagination={false}
      ...
      <div className={styles.availableBalance}>
        <span className={`${darkMode ? '_MyCards_darkMode__DY253' : ''}`}>Available Balance </span>
        <ChangerBtn
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
