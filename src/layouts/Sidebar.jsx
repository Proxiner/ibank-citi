...
function Sidebar() {
  ...
  const hoverHandlerOne = () => {
    defaultActivedLi.current.style.top = "5%";
  };
  const hoverHandlerTwo = () => {
    defaultActivedLi.current.style.top = "21%";
  };
  const hoverHandlerThree = () => {
    defaultActivedLi.current.style.top = "36%";
  };
  const hoverHandlerFour = () => {
    defaultActivedLi.current.style.top = "53%";
  };
      ...
      <div className={styles.sidebarElements}>
        <div className={styles.navigationContainer}>
          <ul className={styles.sidebarNavigation}>
            ...
            <li onMouseOver={hoverHandlerFive} onClick={handleLogout}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                version="1.1"
                width="24"
                height="24"
                className={`${styles.sidebarIcons} , ${styles.logout}`}
              >
                <g>
                  <path
                    fill="#e04141"
                    d="M 7.5,5.5 C 15.84,5.3336 24.1733,5.50027 32.5,6C 34.229,7.7889 34.8957,9.95557 34.5,12.5C 31.8915,12.3944 29.8915,11.2277 28.5,9C 22.8333,8.33333 17.1667,8.33333 11.5,9C 10.3333,9.5 9.5,10.3333 9,11.5C 8.33333,19.5 8.33333,27.5 9,35.5C 9.5,36.6667 10.3333,37.5 11.5,38C 17.1667,38.6667 22.8333,38.6667 28.5,38C 29.8915,35.7723 31.8915,34.6056 34.5,34.5C 34.8957,37.0444 34.229,39.2111 32.5,41C 24.1667,41.6667 15.8333,41.6667 7.5,41C 7,40.5 6.5,40 6,39.5C 5.33333,28.8333 5.33333,18.1667 6,7.5C 6.71719,6.9558 7.21719,6.28913 7.5,5.5 Z"
                  />
                </g>
                <g>
                  <path
                    fill="#e04040"
                    d="M 31.5,14.5 C 36.0582,16.0542 39.3915,19.0542 41.5,23.5C 39.3915,27.9458 36.0582,30.9458 31.5,32.5C 31.0807,29.6755 32.0807,27.5088 34.5,26C 27.5079,25.5004 20.5079,25.3337 13.5,25.5C 13.5,24.1667 13.5,22.8333 13.5,21.5C 20.5079,21.6663 27.5079,21.4996 34.5,21C 32.0807,19.4912 31.0807,17.3245 31.5,14.5 Z"
                  />
                </g>
              </svg>
            </li>
