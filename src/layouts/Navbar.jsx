...
function Navbar() {
  ...
  // const menuDark = () => {
  //   menuIcon.current.children[0].style.stroke = "white";
  //   menuIcon.current.children[1].style.stroke = "white";
  //   menuIcon.current.children[2].style.stroke = "white";
  // };

  // const menuLight = () => {
  //   menuIcon.current.children[0].style.stroke = "black";
  //   menuIcon.current.children[1].style.stroke = "black";
  //   menuIcon.current.children[2].style.stroke = "black";
  // };
        ...
        <div className={styles.actionMobile}>
          ...
          <button class="menu" onClick={handleMenuClick} aria-label="Main Menu">
            <svg width="50" height="50" viewBox="0 0 100 100">
              <path
                class={darkMode ? "lightmode line line1" : "line line1"}
                d="M 20,29.000046 H 80.000231 C 80.000231,29.000046 94.498839,28.817352 94.532987,66.711331 94.543142,77.980673 90.966081,81.670246 85.259173,81.668997 79.552261,81.667751 75.000211,74.999942 75.000211,74.999942 L 25.000021,25.000058"
              />
              <path
                class={darkMode ? "lightmode line line2" : "line line2"}
                d="M 20,50 H 80"
              />
              <path
                class={darkMode ? "lightmode line line3" : "line line3"}
