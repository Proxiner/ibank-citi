...
function Navbar() {
  ...
  const hoverHandlerOne = () => {
    defaultActivedLi.current.style.top = "0%";
  };
  const hoverHandlerTwo = () => {
    defaultActivedLi.current.style.top = "21%";
  };
  const hoverHandlerThree = () => {
    defaultActivedLi.current.style.top = "42%";
  };
  const hoverHandlerFour = () => {
    defaultActivedLi.current.style.top = "65%";
  };
  const hoverHandlerFive = () => {
    defaultActivedLi.current.style.top = "88%";
  };
  const handleLogout = () => {
  ...
  return (
    <nav>
      ...
      <div
        ...
        style={menuClosed ? { left: "-100%" } : { left: "0" }}
      >
        <div className={`${styles.logo}`}>
          <h1 className={styles.logoImage}>B</h1>
          <h3 className={`${styles.logoText}`}>iBank Citi</h3>
